            ...
            $lastId = null;
                foreach($columns as $row){
                    ...
                    echo '<div class="auto">';
                        ...
                        echo '<a class="img-link" href="../contact/indexContact.php?id='.$id.'&model='.$model.'">Contactez-nous</a>';
                        if(isset($_SESSION['role']) && $_SESSION['role'] == 'admin'){
                            echo '<a class="delete-link" href="/src/CRUD-Admin/createUptadeAuto.php?id='.$id.'&action=delete"><img id="delete" src="/img/delete.svg"></a>';
                        }
                        echo '<button class="detail-link"><a href="/src/page-venteAuto/detail.php?id='.$id.'&model='.$model.'">Détails</a></button>';
