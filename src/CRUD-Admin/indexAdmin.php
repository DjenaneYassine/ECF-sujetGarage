...
<body>
    ...
    <ul>
        <form action="" method="POST">
            ...
            <li style="margin-bottom: 40px;"><a href="#"><img class="svg-admin" src="/img/user.svg"><span> Compte employé</span></a></li>
            ...
            <li>GESTION DIFFERENTS SERVICES</li>
            <li style="margin-bottom: 40px;"><a href="/src/CRUD-Admin/indexServ.php"><img class="svg-admin" src="/img/services.svg"><span> Services</span></a></li>
